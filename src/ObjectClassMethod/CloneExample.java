...
public class CloneExample implements Cloneable{
        ...
        public CloneExample(String title, String author, int year)
        {
            this.title = title;
            this.author = author;
            this.year = year;
        ...
        {
            if (obj == null || !(obj instanceof CloneExample)) {
                return false;
            }
            CloneExample other = (CloneExample)obj;
        ...
        @Override public CloneExample clone()
        {
            try {
        ...
        public static void main(String[] args)
        {
            ...
            CloneExample book1 = new CloneExample(
            ...
            // details
            CloneExample book2 = book1.clone();
